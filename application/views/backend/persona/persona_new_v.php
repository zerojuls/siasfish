...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12">
                    <form id="frmNew" action="<?= site_url('persona/agregar_persona') ?>" method="POST" role="form">
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_nombre_completo" name="txt_nombre_completo" class="form-control " placeholder="Ingrese Nombre">
                                </span>
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <input id="cb_tipo_persona" name="cb_tipo_persona" class="row-fluid " />
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
                            <label for="normal-field" class="control-label col-lg-4">Rol de Persona</label>
                            <div class="controls col-lg-8">
                                <input id="cb_rol_persona" name="cb_rol_persona" class="row-fluid " />
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_documento_identidad" name="txt_documento_identidad" class="form-control " placeholder="Ingrese Nro. Documento">
                                </span>
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_telefono" name="txt_telefono" class="form-control " placeholder="Ingrese Telefono">
                                </span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                   // (combo que utilizara esta funcion, mensaje antes del llenado, campo que se mostrara y seleccionara, campo que se enviara, vector de campos de la base de datos, lenguaje español)
